...
function Wordmark({ full = false }: { full?: boolean }) {
  return <Link href="/" className="wordmark" aria-label="Olive Beacon home">{full ? <AnimatedLogo className="wordmark-mark" /> : null}<span>OLIVE</span> BEACON</Link>;
}
